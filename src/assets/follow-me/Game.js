...
FollowMeGame.Game = function (game) {
};

FollowMeGame.Game.prototype = {
	...
	create: function () {
        ...
        this.tapText = this.add.text(this.world.centerX, this.world.centerY, "Double Tap Screen\nto start!", { font: "30px Arial", fill: "#000000", align: "center" });
        this.tapText.anchor.setTo(0.5,0.5);
        this.instructionText = this.add.text(this.world.centerX, this.world.centerY+180, "Follow the pattern\nset by the computer.\nTap the same boxes\nin the same order.", { font: "20px Arial", fill: "#000000", align: "center" })
        this.instructionText.anchor.setTo(0.5,0.5);

        this.scoreText = this.add.text(this.world.centerX, this.world.centerY-150, "0", { font: "30px Arial", fill: "#000000", align: "center" });
        this.scoreText.anchor.setTo(0.5,0.5);
        this.scoreText.alpha = 0;

        this.playerText = this.add.text(this.world.centerX, this.world.centerY-190, "Computer", { font: "30px Arial", fill: "#000000", align: "center" });
