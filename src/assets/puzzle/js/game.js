/* 
 * Game
 * The main Coco Puzzle game, a singleton object in global scope.
 * (c) 2015 Q42
 * http://q42.com | @q42
...
var Game = new (function() {
  ...
  function resize() {
    var desired = {
        ...
        viewport = {
          width: $('#main-puzzle-container').width(),
          height: $('#main-puzzle-container').height()
        },
    ...
    $('h1').css('font-size', Math.round(containerSize * .16) + 'px')
    $('h2').css('font-size', Math.round(containerSize * .12) + 'px')
    $('h3').css('font-size', Math.round(containerSize * .15) + 'px')
    $('p').css('font-size', Math.round(containerSize * .07) + 'px')
    $('#menu h2').css('font-size', Math.round(containerSize * .16) + 'px')
    ...
    $('.puzzle-game-icon').css({width:iconSize,height:iconSize,marginLeft:iconSize * 0.7, marginRight:iconSize * 0.7 });
